...
<head>
    ...
    <title>Laravel 8 Multi guards | Registration Page</title>
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" value="{{old('phone')}}" id="phone" placeholder="Phone">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-4">
                            <button type="button" onclick="create()" class="btn btn-primary btn-block">Register</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
